...
enum instruction_type {I,IBranch,I1Branch,IBranchComp,I1,IDisp,INot,J,R,R0,R1RS,RDRS,RDRT,R1RT,R1RD,RSH};
...
#define OPCODE_NAND   0x0
#define OPCODE_XOR    0x1
#define OPCODE_ADDI   0x2
#define OPCODE_ADD    0x3
#define OPCODE_SUB    0x4
#define OPCODE_SHRA   0x5
#define OPCODE_SHL    0x6
#define OPCODE_BGT    0x7
#define OPCODE_BEQZ   0x8
#define OPCODE_LW     0x9
#define OPCODE_SW     0xA
#define OPCODE_J      0xB
...
//#define OPCODE_ADD    0x62
//#define OPCODE_ADDI   0x63
//#define OPCODE_SUB    0x64
#define OPCODE_SHR    0x65
//#define OPCODE_SHL    0x66
...
instruction_t opcode_arr[] = {
    instruction_t(OPCODE_NAND,   "nand",  R),
    ...
    instruction_t(OPCODE_BEQZ,   "beqz",  I1Branch),
